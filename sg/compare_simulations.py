...
if __name__ == '__main__':
    ...
    dataarrays = {}
    for var in ['SpeciesConc_O3', 'SpeciesConc_CO', 'SpeciesConc_NO', 'SpeciesConc_NO2']:
        ...
        da.attrs['r-squared'] = sklearn.metrics.r2_score(y_true=x, y_pred=y)
        da.attrs['rmse'] = np.sqrt(sklearn.metrics.mean_squared_error(y_true=x, y_pred=y))
        da.attrs['mae'] = sklearn.metrics.mean_absolute_error(y_true=x, y_pred=y)
        dataarrays[var] = da
