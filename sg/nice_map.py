...
plt.savefig(f'frames-no-overlay/{time.year:4d}{time.month:02d}{time.day:02d}_{time.hour:02d}{time.minute:02d}z.jpeg', dpi=100, facecolor='#151515', edgecolor='#151515')
# plt.show()