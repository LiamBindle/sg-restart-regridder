...
if __name__ == '__main__':
    ...
    start_date = base_date - pd.DateOffset(hours=12)
    end_date = base_date + pd.DateOffset(hours=12)
    ...
    ds2 = ds.sel(time=ds.solar_time, method='nearest', tolerance=np.timedelta64(10, 'm'))
